...
We implemented each of the simple solutions described in section \ref{sec:simple}, and compared their performance to range coalescing on a variety of data sets. 
...
\begin{tikzpicture}
\begin{axis}[
    title={Query times vs k (for fixed n=100)},
    xlabel={k},
...
\begin{tikzpicture}
\begin{axis}[
    title={Query times vs n (for fixed k=1000)},
    xlabel={n},
    ylabel={Query time ($\mu$s)},
    xmin=50, xmax=5000,
    ymin=0, ymax=800,
